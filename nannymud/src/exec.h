...
#define SHORT_LINE_NUMBERS

struct function {
    char *name;
    unsigned short offset;	/* Address of function,
				 * or offset in function table when inherited
				 */
    ...
    unsigned char inherit_offset; /* Which inherit */
...
#define TYPE_FLOAT      7       /* Floating point, pen@lysator.liu.se */
