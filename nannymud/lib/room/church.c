...
/* Priest moved east to the nwe wedding chapel. Brom 960216 */
...
/*****************************************
 * Priest moved east to wedding chapel 960216.
 * Brom
 ...
 */
  ...
  add_exit("east", "chapel");
  set_short("village church");
  set_long(LB("You are in the local village church.\n"+
  ...
  add_item("pit",
	   LB("In the middle of the church is a deep pit. "+
