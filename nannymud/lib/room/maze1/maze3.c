...
maze() {
  ...
  if (exit_num>4) {
    write("Yeah! This is going well. You are on the right way.\n");
    this_player()->move_player("further in the maze#room/maze1/maze4");
    return 1; }
  else if (exit_num>0) {
    write("Hmm! Maybe not a good choice.\n");
    this_player()->move_player("further in the maze#room/maze1/maze2");
    return 1; }
  else {
