...
#define FREE_QUESTS	4

/* NannyMUD's new quest system, with quest points, is different.
 * Each quest gives a number of points (100 by default),
 * and to become a wizard, you must have at least
 * QUEST_POINTS_PERCENT_TO_WIZ per cent of the
 * max number of points. /Padrone
 *
 */

#define QUEST_POINTS_PERCENT_TO_WIZ	65

/*
 * If this is defined, the playerkiller flag will have effect. 
 */
#define USE_PK_FLAG
