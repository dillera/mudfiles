...
reset(arg) {
  if (!arg) {
    ...
    add_exit("north", "pine_wood5");
    add_exit("east",  "pine_wood3");
    add_exit("south", "pine_wood_track");
    add_exit("west",  "pine_wood1");
    ...
    set_long
      ("The trees here are over a hundred feet tall, making any climbing projects\n"+
       ...
       "chilly here. A faint track goes north and south.\n");
    ...
    add_item( ({ "track", "faint track" }),
	     "It looks like an animal track here in the woods. It goes north-south.\n");
  }
} /* reset */
