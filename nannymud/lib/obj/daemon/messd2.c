...
([
  ...
  "pierce": ({
    ...
    "impaled", " just inches from the heart",
  }),
  ...
  "electricity": ({
    ...
    "gave", " a jolt",
    "shocked", "",
    "shocked", " causing spasms",
    "made bolts of lightning crawl all over", "",
    "engulfed", "in a huge ball of lightning",
    "electrocuted", " leaving a smoking husk",
  }),
  "cold": ({
    "missed", "",
    "chilled", " slightly",
    "numbed", "",
    "gave", " serious frostbites",
  ...
  "drain": ({
    ...
    "drained", " heavily",
    "withered", " horribly",
    "sucked all life from", "",
    "perished the very soul of", "",
  }),
  ]);
